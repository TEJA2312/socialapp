...
// app.post('/home/:id/like',isLoggedIn,(req,res)=>{
...
// profile.save().then((docs,err)=>{
// 	if(err){
// 		console.log("error in save is :",err);
// 	}else{
...
// app.get('/user/new',(req,res)=>{// should come first in code than [:id] cause u know why
...
// record error look if stuck ___||____||____

//app.delete('user/:id',(req,res)=>  here was missing / before user
